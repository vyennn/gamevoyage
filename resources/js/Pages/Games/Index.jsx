...
export default function Index({ games, userFavorites, userNotes, auth }) {
    ...
    return (
        <>
            <Head title="Quest Chronicle - Your Gaming Journey" />

            <div ref={containerRef} className="min-h-screen bg-black text-white overflow-x-hidden">
                {/* Cursor Follower */}
                <motion.div
                    className="fixed w-6 h-6 border-2 border-pink-500 rounded-full pointer-events-none z-50 mix-blend-difference hidden lg:block"
                    animate={{
                ...
                <motion.header
                    initial={{ y: -100 }}
                    animate={{ y: 0 }}
                    className="fixed top-0 left-0 right-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/5"
                >
                            ...
                            <div className="flex flex-col lg:flex-row gap-4">
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-14 pr-6 py-5 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all text-lg"
                                    />
                                </div>
                                <motion.button
                                ...
                                >
                                    ...
                                    <span className="bg-white/20 px-2 py-1 rounded-full text-sm">{favorites.length}</span>
                                </motion.button>
                            </div>
    ...
    <div className="container mx-auto px-4 lg:px-8 max-w-7xl w-full">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-xs mt-4">
                                © 2025 Quest Chronicle. All rights reserved.
                            </p>
                        </motion.div>
                    </div>
                </footer>
